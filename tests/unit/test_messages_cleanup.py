...
def test_messages_cleanup(test_dirs):
    ...
    assert os.path.exists(subdir1) is False
    assert os.path.exists(file1) is False
    assert os.path.exists(file2) is False

    assert os.path.exists(subdir2) is True
    assert os.path.exists(file3) is False
    assert os.path.exists(file4) is False
    assert os.path.exists(file5) is True

    assert os.path.exists(subdir3) is True
    assert os.path.exists(file6) is True
    assert os.path.exists(file7) is True
    assert os.path.exists(file8) is True
