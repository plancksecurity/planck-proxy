...
def init_msg():
    ...
    """
    return {
        'inmail': None, 'msgfrom': None, 'msgto': None, 'src': None, 'dst': None,
    }
...
def init_person():
    ...
    return {
        'addr': None, 'key': None, 'keyname': None, 'keyaddr': None, 'keyfpr': None, 'pepid': None,
    }
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--settings_file', help=('Provides a route to a different "settings.json" file.'), default=None)
